...
mount(Start, {
  ...
  props: {
    start,
    sshKeys: [
      { path: '/home/dev/.ssh/id_ed25519', publicPath: '/home/dev/.ssh/id_ed25519.pub',
        comment: 'dev@example', kind: 'ed25519' },
    ],
...
mount(Toolbar, {
  ...
  props: {
    ...
    leftPanel: 'open', rightPanel: true, rightPanelUsable: true,
...
mount(StatusBar, {
  ...
  props: {
    ...
    gitVersion: '2.43.0',
    host: {
      host: { kind: 'github', origin: 'github.com', owner: 'coral', repo: 'coral' },
      detail: null,
      token: 'none',
    },
    report: null,
...
toasts.push('error', 'Could not fetch upstream', 'Host key verification failed.');
...
mount(Menu, {
  ...
  props: {
    ...
    items: [
      ...
      { kind: 'item', label: 'Create branch here', hint: 'Ctrl B', run: () => {} },
      { kind: 'separator' },
      { kind: 'submenu', label: 'Reset master to this commit', items: [
